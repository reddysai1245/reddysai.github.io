...
<form action="addnews.php" method="POST">
    ...
    <div class="r">
       ...
       <div class="form-group col-md-12">
           <label>news id</label>
          <input type="text" name="id" class="form-control" minlength="2" maxlength="8" pattern="\d{2-8}" title="enter a valid registration number"required>
       </div>

 	  <div class="form-group">
         <label>Enter news</label>
          <textarea class="form-control"  rows="3" name="news" required></textarea>
      </div>
  
       <button type="submit" name="submitnew" class="btn btn-outline-dark btn-lg">submit</button><br><br>
</form>
<form action="addnews.php" method="POST">
