...
<!--here comes the fetching details of the person logged in-->
...
<?php if(isset($_SESSION['regno'])) : ?>
 ...
 <?php  $_SESSION['regno']; 
      ...
      <?php 
         $q="SELECT * FROM `detais` WHERE regno='$s'";
        ...
        echo"<div class='container'>
                <div class='row'>
                    <div class='col'>";
                      ...
                      echo"<div class='col'><h4>regno : ".$row[1]." </h4><br></div>
                </div>
              </div>";
              echo "<br>";
       // echo"<div class='mDIV'><button class='btn btn-outline-secondary' type='button' id='formButton'>click here to fetch more</button>";
        ...
        echo"<div class='container'>
                  <div class='row'>
                      <div class='col'>";echo"<h4>dept  : ".$row[2]."  </h4><br></div>";
                    echo"<div class='col'><h4>email : ".$row[3]."  </h4><br></div>
                  </div>
                </div>";
                echo "<br>";
                echo"<div class='container'>
                  <div class='row'>
                      <div class='col'>";
                          echo"<h4>dob : ".$row[4]."  </h4><br></div>";

        echo"<div class='col'><h4>mobile no : ".$row[5]."  </h4><br></div></div></div>";
        echo "<br>";
        echo"<div class='container'>
                  <div class='row'>
                      <div class='col'>";
        echo"<h4>parent name : ".$row[6]."  </h4><br></div>";
        echo"<div class='col'><h4>parent mob : ".$row[7]."  </h4><br></div></div></div>";
        //echo"</div></div></div>";
