...
<form action="delano.php" method="POST">
	<?php include('erreo.php') ?>
<div class="r">
	<h5><?php echo "welcome ";
	 echo$_SESSION['admin'];?></h5><br>
<div class="form-group col-md-12">
      <label>enter anouncement id to delete</label>
 ...
 <button type="submit" name="delano" class="btn btn-outline-dark btn-lg">submit</button><br><br></form>
<form action="delano.php" method="POST">
